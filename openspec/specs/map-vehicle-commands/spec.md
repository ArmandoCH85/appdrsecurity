...
> **Vigente en main (OpenSpec).** Sincronizado desde el cambio archivado el 2026-04-23.

**Tipo:** Especificación completa (no había `openspec/specs` previa para este dominio).
